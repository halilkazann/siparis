...
<header class="h-16 w-full bg-white p-5 flex justify-between items-center">
    <form method="get" action="siparis_gonder.php">
        <input class="bg-gray-200 h-12 w-80 p-2 outline-none rounded-sm" type="text"  id="" placeholder="Lütfen Bir Değer Giriniz...">
        <button class="p-3 bg-gray-400 font-semibold text-md h-12 rounded-sm text-white hover:bg-gray-600 transition-all duration-100">Siparişi T-Soft'a Göder</button>
...
?>
    ...
    echo $sayfa;
    if(!empty($page)){
           echo '<div class="w-full flex justify-center align-bottom my-5 space-x-5">';

            
            echo '<a class="font-semibold text-lg" href="dashboard.php?page="'.$page-$i.'>'.$page-$i.' </a>';
